...
def cars_EDA(df):
    ...
    **연비(mpg)와 주요 변수들 간의 관계, 대륙별 특성, 연도별 변화** 등을 탐색합니다.
    ...
    # st.subheader("🐎마력(hp)과 차량 무게의 관계")
    # fig5 = px.scatter(
    #     df,
    #     x="hp",
    #     y="weightlbs",
    ...
    st.subheader("🪫엔진 배기량(cubicinches)과 연비의 관계")
    fig6 = px.scatter(
        df,
        x="cubicinches",
        y="mpg",
